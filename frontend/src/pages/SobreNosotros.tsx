...
const SobreNosotros: React.FC = () => {
  return (
    <div className="w-full bg-[#fcfbfa] min-h-screen">
      ...
      <section className="py-20 px-6 md:px-12 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-7 space-y-6">
            <div className="flex items-center space-x-2 text-xs font-semibold text-[#8cc550] uppercase tracking-widest">
          ...
          <div className="lg:col-span-5">
            <div className="relative p-8 bg-white border border-gray-100 rounded-2xl shadow-xl overflow-hidden group">
              <div className="absolute top-0 right-0 w-24 h-24 bg-[#8cc550]/5 rounded-bl-full transition-all duration-300 group-hover:scale-110"></div>

              <div className="space-y-6 relative z-10">
                <div className="w-12 h-12 bg-[#8cc550]/10 rounded-xl flex items-center justify-center text-[#8cc550]">
                ...
                <ul className="space-y-3 text-gray-600">
                  <li className="flex items-center space-x-3">
                    <span className="w-1.5 h-1.5 bg-[#8cc550] rounded-full"></span>
      ...
      <section className="bg-white py-20 px-6 md:px-12 border-y border-gray-100">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <span className="text-xs font-semibold text-[#8cc550] uppercase tracking-widest block mb-3">Historia Notarial</span>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
            <div className="lg:col-span-4 flex flex-col items-center">
              <div className="w-full bg-[#fcfbfa] border border-gray-100 p-8 rounded-2xl shadow-sm text-center">
                ...
                <span className="text-[#8cc550] text-sm font-semibold uppercase tracking-wider block mt-1 mb-4">Notario Titular</span>
                <p className="text-gray-500 text-sm leading-relaxed mb-6">
                  Dirección jurídica de excelencia enfocada en la fe pública y la rigurosidad ética.
                </p>
                <Link
                  to="/abogados"
                  className="inline-flex items-center space-x-2 text-xs font-bold text-[#8cc550] hover:text-[#7ab345] uppercase tracking-wider transition-colors"
                >
            ...
            <div className="lg:col-span-8 space-y-8 relative before:absolute before:left-4 before:top-2 before:bottom-2 before:w-[2px] before:bg-gray-100">
              <div className="flex space-x-6 relative pl-8">
                <div className="absolute left-[9px] w-4 h-4 bg-[#8cc550] border-2 border-white rounded-full flex items-center justify-center shadow"></div>
                <div className="space-y-2">
                  <span className="text-xs font-semibold text-[#8cc550] uppercase tracking-widest">Designación Oficial</span>
              ...
              <div className="flex space-x-6 relative pl-8">
                <div className="absolute left-[9px] w-4 h-4 bg-[#8cc550] border-2 border-white rounded-full flex items-center justify-center shadow"></div>
                <div className="space-y-2">
                  <span className="text-xs font-semibold text-[#8cc550] uppercase tracking-widest">Proceso de Selección</span>
              ...
              <div className="flex space-x-6 relative pl-8">
                <div className="absolute left-[9px] w-4 h-4 bg-[#8cc550] border-2 border-white rounded-full flex items-center justify-center shadow"></div>
                <div className="space-y-2">
                  <span className="text-xs font-semibold text-[#8cc550] uppercase tracking-widest font-sans">21 de Noviembre, 2013</span>
              ...
              <div className="flex space-x-6 relative pl-8">
                <div className="absolute left-[9px] w-4 h-4 bg-[#8cc550] border-2 border-white rounded-full flex items-center justify-center shadow"></div>
                <div className="space-y-2">
                  <span className="text-xs font-semibold text-[#8cc550] uppercase tracking-widest">11 de Diciembre, 2013</span>
      ...
      <section className="py-20 px-6 md:px-12 max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <span className="text-xs font-semibold text-[#8cc550] uppercase tracking-widest block mb-3">Garantía Constitucional</span>
          <h2 className="text-3xl md:text-4xl font-heading font-bold text-dark">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-white border border-gray-100 p-8 rounded-2xl shadow-sm hover:shadow-md transition-shadow duration-300">
            <div className="w-12 h-12 bg-[#b89369]/10 rounded-xl flex items-center justify-center text-[#8cc550] mb-6">
              <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
