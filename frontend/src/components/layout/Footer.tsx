        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 items-start">
          <div className="md:col-span-3 flex flex-col items-center md:items-start space-y-6">
            <Link to="/" className="text-3xl font-heading font-bold tracking-tight text-white">
              Notaría <span className="text-primary">43</span>
            </Link>
            ...
            <div className="flex space-x-4 pt-2">
              <a
                ...
                className="w-10 h-10 rounded-full border border-gray-600 flex items-center justify-center text-gray-400 hover:text-primary hover:border-primary transition-all duration-300 transform hover:scale-105"
              >
          ...
          <div className="md:col-span-5 border-t md:border-t-0 md:border-r border-gray-700/60 pt-8 md:pt-0 md:pr-8">
            ...
            <ul className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-2 text-sm text-gray-400">
              {services.map((service, index) => (
                <li
                  key={index}
                  className="flex items-center space-x-2 hover:text-primary transition-colors duration-200 cursor-pointer py-1"
                >
          ...
          <div className="md:col-span-4 space-y-6 pt-8 md:pt-0">
            <h3 className="text-xl font-heading font-bold text-white leading-tight">
              La Notaría <span className="text-primary font-medium font-sans italic text-lg font-semibold block sm:inline">cuadragésima tercera</span> del cantón Quito
            </h3>
            <div className="space-y-4 text-sm text-gray-400">
              ...
              >
                <svg className="w-5 h-5 text-primary group-hover:scale-110 transition-transform shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className="flex items-center space-x-3">
                <svg className="w-5 h-5 text-primary shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <a href="mailto:contacto@notaria43.com" className="hover:text-primary transition-colors">contacto@notaria43.com</a>
                </div>
              </div>
            </div>
